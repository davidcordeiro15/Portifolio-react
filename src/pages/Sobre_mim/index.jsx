...
function Sobre_mim() {
    ...
    return (    
        ...
        <div className="flex justify-between m-2 mt-10 min-h-screen gap-10">
            ...
            <p className="m-5 mt-8 ">Atualmente crio desafios para mim mesmo a fim de desenvolver programas, utilizando, <p className="font-bold ">Java com SpringBoot, Python, React com JavaScript, SQL com PostGreSQL, HTML e CSS. </p></p>
